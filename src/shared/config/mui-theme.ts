  ...
  components: {
    MuiCssBaseline: {
      styleOverrides: {
        ...
        'ul.MuiAutocomplete-listbox::-webkit-scrollbar': {
          width: 6,
          height: 6,
        },
        'ul.MuiAutocomplete-listbox::-webkit-scrollbar-track': {
          background: 'rgba(255, 255, 255, 0.02)',
          borderRadius: 4,
        },
        'ul.MuiAutocomplete-listbox::-webkit-scrollbar-thumb': {
          background: 'rgba(138, 43, 226, 0.35)',
          borderRadius: 4,
        },
        'ul.MuiAutocomplete-listbox::-webkit-scrollbar-thumb:hover': {
          background: 'rgba(138, 43, 226, 0.5)',
        },
      },
    },
